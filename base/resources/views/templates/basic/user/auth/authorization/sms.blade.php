            ...
            <div class="account-form-box-wrapper">
                <div class="account-form-box">
                    ...
                    <div class="account-form-box__content">
                        ...
                        <h3 class="account-form-box__title">@lang('Verify Mobile Number')</h3>
                        <p class="account-form-box__desc">@lang('A 6 digit verification code sent to your mobile number.')</p>
                    </div>
