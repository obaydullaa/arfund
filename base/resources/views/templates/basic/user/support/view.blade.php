    ...
    <div class="col-md-12">
        <div class="dashboard-card-wrap">
            <div class=" d-flex flex-wrap justify-content-between align-items-center">
                <h5 class="title-two mt-0">
                    @php echo $myTicket->statusBadge; @endphp
                    [@lang('Ticket')#{{ $myTicket->ticket }}] {{ $myTicket->subject }}
                </h5>
                @if($myTicket->status != Status::TICKET_CLOSE && $myTicket->user)
                <button class="btn btn-danger close-button btn-sm confirmationBtn mb-3" type="button" data-question="@lang('Are you sure to close this ticket?')" data-action="{{ route('ticket.close', $myTicket->id) }}">
        ...
        <div class="dashboard-card-wrap mt-4">
            <div class="card-body">
