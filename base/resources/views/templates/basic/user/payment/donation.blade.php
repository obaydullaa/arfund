                    ...
                    <form action="{{route('deposit.insert')}}" method="post">
                        ...
                        <div class="dashboard-card-wrap">
                            <div class="title-two mb-4">
                                <h5 class="card-title">@lang('Donation of') "{{ $campaign->title}}"</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="amount" class="form-control form--control" value="{{ $donation->donation }}" autocomplete="off" required readonly>
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn--base mt-3">
                                        @lang('Submit')
                                    </button>
                                </div>
                            </div>
