                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="@lang('Status')">
                                        @if($item->completed == Status::YES || $item->date < now() && $item->completed == Status::YES)
                                    ...
                                    <td data-label="@lang('Action')">
                                        <div class="div">
                                            ...
                                            @if ($item->status == 0)
                                                <a href="{{ route('user.campaign.edit', $item->id) }}" class="table-btn table-btn--success" title="Edit">
