...
class WithdrawController extends Controller
{
    ...
    public function withdrawMoney()
    {
        ...
        return view(activeTemplate().'user.withdraw.methods', compact('pageTitle','withdrawMethod'));
    }
    ...
    public function withdrawPreview()
    {
        ...
        return view(activeTemplate() . 'user.withdraw.preview', compact('pageTitle','withdraw'));
    }
    ...
    public function withdrawLog(Request $request)
    {
        ...
        return view(activeTemplate().'user.withdraw.log', compact('pageTitle','withdraws'));
    }
}
